  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          `flex h-14 w-full rounded-md border border-slate-600 bg-white px-6 py-2 text-base 
           ring-offset-white file:border-0 file:bg-transparent file:text-base file:font-medium
